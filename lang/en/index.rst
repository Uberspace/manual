...
.. note:: Please keep in mind that Uberspace 7 is considered **beta**. That means we're far from being feature complete. 
  ...
  We're working on implementing (in no specific order) ruby, erlang, PostgreSQL, CouchDB, MongoDB, backups, Adminer, phpMyAdmin, custom backends instead of apache, open ports in the firewall, gitolite, redis, SpamAssassin, webmail, ...
