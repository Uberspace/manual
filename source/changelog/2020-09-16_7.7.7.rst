...
* The number of simultaneous SMTP connections is now limited, closing an easy
  but harmless DoS vector. Additionally, we support added more SMTP connection
  slots.

Changed
-------

* New accounts now come with a index.html explaining how to upload content,
...
* Web Backends now serve their content at both `/etherpad` and `/etherpad/`,
  partly reverting the change made in 7.7.6 because of incompatability with
