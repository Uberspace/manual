.. _qmail-mailaddr-and-vmailmgr-user-blocking:

The file conflicts with an already existing mail user
=====================================================

``id:qmail-mailaddr-and-vmailmgr-user-blocking``

This error indicates, that you have a qmail file like ``.qmail-mailbox`` but likewise a mail user ``mailbox``. The qmail
file contains a mailaddress and forwards all mails to this configured address while the mailuser cannot receive the
incoming mails.
