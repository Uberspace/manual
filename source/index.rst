...
.. note:: We're working on implementing (in no specific order) erlang, PostgreSQL, CouchDB, custom backends instead of apache, open ports in the firewall, gitolite …
