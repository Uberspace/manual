...
For your ``@uber.space`` address the passwort will be the one of your linux user. THis means it's the as for SSH access, which you can set in your dashboard `here
